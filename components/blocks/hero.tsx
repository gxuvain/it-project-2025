...
function Hero({ ref, className, gradient = true, blur = true, title, subtitle, actions, titleClassName, subtitleClassName, actionsClassName, ...props }: HeroProps & { ref?: React.RefObject<HTMLElement | null> }) {
  return (
    <section
      ref={ref}
      className={cn(
