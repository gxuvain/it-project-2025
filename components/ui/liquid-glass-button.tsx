...
// eslint-disable-next-line react-refresh/only-export-components, ts/no-use-before-define
...
function metalButtonVariants(variant: ColorVariant = "default", isPressed: boolean, isHovered: boolean, isTouchDevice: boolean) {
...
export function MetalButton({ ref, children, className, variant = "default", ...props }: MetalButtonProps & { ref?: React.RefObject<HTMLButtonElement | null> }) {
